import{d as s}from"./dom-7f8f01b1.js";(function(t){let l=function a(o){return t("[data-loading-icon]").each(function(){let e=t(this).data("color")!==void 0?t(this).data("color"):t("body").css("color"),i=t(this).attr("class")!==void 0?t(this).attr("class"):"",c=[{name:"audio",svg:`
                ...
                `}],r=this;c.forEach(function(n){t(r).data("loading-icon")==n.name&&t(r).replaceWith(n.svg)})}),a}();(function(){window.tailwind===void 0&&(window.tailwind={}),window.tailwind.svgLoader=function(){l()}})()})(s);
